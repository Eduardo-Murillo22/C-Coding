...
int main(int argc, char** argv) {
    ...
    cout << "Would you like to play? Enter Y for yes or N for no: " << endl << endl;
...
void Play(bool &PLAY){
                        ...
                        while (x == false) {
                            ...
                            switch (choice) {
                                ...
                                case 3:{
                                        ...
                                        players[i].Bet(players[i].getBet());
                                        players[i].modeBet(b*2);
    ...
    dealerValue = dealer.dealerPlay();
    
    
    cout << endl <<endl <<endl;
    cout << "Dealers Card Value Is: " << dealerValue << endl;
    for(int i =0;i < Nplay;i++){
    ...
    for(int i =0;i < Nplay;i++){
        if(players[i].getBet() >= 10){
            ...
            if(PlayerCardV[i] >= 22){
                //got more than 21 take there bet away
                cout << players[i].getName() << ", You got more then 21 so you lose and lose all your money." << endl;
                                
            }
            else if(PlayerCardV[i] > dealerValue){
                
                cout << players[i].getName() << ", Congrats You Have " << PlayerCardV[i] << " and the dealer has " << dealerValue << endl ;
                ...
                cout << players[i].getName() << ", Sorry You Lost you have " << PlayerCardV[i] << " and the dealer has " << dealerValue << endl;
                ...
                // It's a tie
                cout << players[i].getName() << ", You tied. You have: " << PlayerCardV[i] << " and the dealer has " << dealerValue << endl;
